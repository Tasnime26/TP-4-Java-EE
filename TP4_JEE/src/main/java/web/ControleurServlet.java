...
model.setMotCle(motCle);// il a remplie l'obket modele il a affecter le mots cle 
...
request.setAttribute("produit", p);//une fois le produit et modifier on ajoute le meodele produit et on passe a la page confiramtion.jsp 
request.getRequestDispatcher("confirmation.jsp").forward(request,response);
}
